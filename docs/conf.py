...
"""
openedx-edit-links documentation build configuration file.
...
project = 'openedx-edit-links'
copyright = edx_theme.COPYRIGHT  # pylint: disable=redefined-builtin
author = edx_theme.AUTHOR
project_title = 'Open edX Edit Links'
...
#
# html_title = 'openedx-edit-links v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'Add Edit links to course content that allows students to contribute changes to FOSS courses',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'edit_links'),
                os.path.join(root_path, 'edit_links/migrations')])
