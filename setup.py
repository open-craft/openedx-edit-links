#!/usr/bin/env python
"""
Package metadata for edit_links.
"""
import os
import re
import sys
...
setup(
    name='openedx-edit-links',
    version=VERSION,
    description="""Add Edit links to course content that allows students to contribute changes to FOSS courses""",
    long_description=README + '\n\n' + CHANGELOG,
    author='edX',
    author_email='oscm@edx.org',
    url='https://github.com/edx/openedx-edit-links',
    packages=[
        'edit_links',
    ],
    entry_points={
